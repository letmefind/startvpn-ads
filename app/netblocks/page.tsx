      ...
      <main className="relative mx-auto w-full max-w-5xl px-4 py-10 pb-20 md:px-8 md:py-14">
        ...
        <section className="mt-14 rounded-2xl border border-slate-700/80 bg-slate-950/50 p-5 text-sm leading-7 text-slate-500">
          ...
          <p>
            ...
            ). تایم‌لاین ایکس با ویجت رسمی نمایش داده می‌شود؛ استفادهٔ منصفانه با ذکر منبع مطابق
            سیاست نت‌بلاکس است. این صفحه فقط فهرست‌کننده است و تحلیل مستقل ارائه نمی‌کند.
          </p>
          <p className="mt-3">
            ...
            بگیرید (خروجی استاتیک با تاریخ ساخت تازه می‌شود). بخش ایکس در مرورگر زنده است؛ ترجمهٔ
            عنوان و خلاصه در همان مرحلهٔ build انجام می‌شود.
          </p>
        </section>
      </main>
